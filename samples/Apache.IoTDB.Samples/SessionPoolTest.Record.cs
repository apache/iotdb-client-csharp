...
namespace Apache.IoTDB.Samples
{
    public partial class SessionPoolTest
    {
        ...
        public async Task TestInsertStrRecord()
        {
            ...
            var rowRecord = new RowRecord(1, values, measures, new List<TSDataType> { TSDataType.INT32, TSDataType.INT32 });
            ...
            for (var timestamp = 2; timestamp <= fetchSize * processedSize; timestamp++)
                rowRecords.Add(new RowRecord(timestamp, values, measures, new List<TSDataType> { TSDataType.INT32, TSDataType.INT32 }));
        ...
        public async Task TestInsertRecords()
        {
            ...
            var rowRecords = new List<RowRecord>() { };
            rowRecords.Add(new RowRecord(timestamp_lst[0], values_lst[0], measurements_lst[0],
                new List<TSDataType> { TSDataType.BOOLEAN, TSDataType.INT32 }));
            rowRecords.Add(new RowRecord(timestamp_lst[1], values_lst[1], measurements_lst[1],
                new List<TSDataType> { TSDataType.BOOLEAN, TSDataType.INT32, TSDataType.INT64, TSDataType.DOUBLE }));
            rowRecords.Add(new RowRecord(timestamp_lst[2], values_lst[2], measurements_lst[2],
                new List<TSDataType> { TSDataType.BOOLEAN, TSDataType.INT32, TSDataType.INT64, TSDataType.DOUBLE, TSDataType.FLOAT, TSDataType.TEXT }));
