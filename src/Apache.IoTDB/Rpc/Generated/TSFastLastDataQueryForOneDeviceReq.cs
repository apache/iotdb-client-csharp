...
public partial class TSFastLastDataQueryForOneDeviceReq : TBase
{
            ...
            {
              {
                ...
                Sensors = new List<string>(_list268.Count);
                for(int _i269 = 0; _i269 < _list268.Count; ++_i269)
                {
                  string _elem270;
                  _elem270 = await iprot.ReadStringAsync(cancellationToken);
                  Sensors.Add(_elem270);
                }
  ...
  public async Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
  {
    ...
    try
    {
      ...
      await oprot.WriteFieldBeginAsync(field, cancellationToken);
      {
        ...
        foreach (string _iter271 in Sensors)
        {
  ...
  {
    var other = that as TSFastLastDataQueryForOneDeviceReq;
