...
public partial class TSRawDataQueryReq : TBase
{
      ...
      while (true)
      {
        ...
        switch (field.ID)
        {
          ...
          case 2:
            ...
            {
              {
                TList _list260 = await iprot.ReadListBeginAsync(cancellationToken);
                Paths = new List<string>(_list260.Count);
                for(int _i261 = 0; _i261 < _list260.Count; ++_i261)
                {
                  string _elem262;
                  _elem262 = await iprot.ReadStringAsync(cancellationToken);
                  Paths.Add(_elem262);
                }
  ...
  public async Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
  {
    ...
    try
    {
      ...
      await oprot.WriteFieldBeginAsync(field, cancellationToken);
      {
        ...
        foreach (string _iter263 in Paths)
        {
  ...
  {
    var other = that as TSRawDataQueryReq;
