...
public partial class TSAggregationQueryReq : TBase
{
            ...
            {
              {
                ...
                Paths = new List<string>(_list272.Count);
                for(int _i273 = 0; _i273 < _list272.Count; ++_i273)
                {
                  string _elem274;
                  _elem274 = await iprot.ReadStringAsync(cancellationToken);
                  Paths.Add(_elem274);
                }
            ...
            {
              {
                ...
                Aggregations = new List<TAggregationType>(_list275.Count);
                for(int _i276 = 0; _i276 < _list275.Count; ++_i276)
                {
                  TAggregationType _elem277;
                  _elem277 = (TAggregationType)await iprot.ReadI32Async(cancellationToken);
                  Aggregations.Add(_elem277);
                }
                await iprot.ReadListEndAsync(cancellationToken);
              }
  ...
  public async Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
  {
    ...
    try
    {
      ...
      await oprot.WriteFieldBeginAsync(field, cancellationToken);
      {
        ...
        foreach (string _iter278 in Paths)
        {
          await oprot.WriteStringAsync(_iter278, cancellationToken);
        }
      ...
      await oprot.WriteFieldBeginAsync(field, cancellationToken);
      {
        ...
        foreach (TAggregationType _iter279 in Aggregations)
        {
          await oprot.WriteI32Async((int)_iter279, cancellationToken);
        }
        await oprot.WriteListEndAsync(cancellationToken);
      }
      await oprot.WriteFieldEndAsync(cancellationToken);
  ...
  {
    var other = that as TSAggregationQueryReq;
