...
public partial class TSCloseOperationReq : TBase
{
  ...
  {
    var tmp113 = new StringBuilder("TSCloseOperationReq(");
    tmp113.Append(", SessionId: ");
    SessionId.ToString(tmp113);
    if(__isset.queryId)
    {
      tmp113.Append(", QueryId: ");
      QueryId.ToString(tmp113);
    }
    if(__isset.statementId)
    {
      tmp113.Append(", StatementId: ");
      StatementId.ToString(tmp113);
    }
    tmp113.Append(')');
