...
public partial class TThrottleQuota : TBase
{
            ...
            {
              {
                ...
                ThrottleLimit = new Dictionary<ThrottleType, TTimedQuota>(_map33.Count);
                for(int _i34 = 0; _i34 < _map33.Count; ++_i34)
                {
                  ThrottleType _key35;
                  TTimedQuota _val36;
                  _key35 = (ThrottleType)await iprot.ReadI32Async(cancellationToken);
                  _val36 = new TTimedQuota();
                  await _val36.ReadAsync(iprot, cancellationToken);
                  ThrottleLimit[_key35] = _val36;
                }
    ...
    try
    {
      ...
      if (ThrottleLimit != null && __isset.throttleLimit)
      {
        ...
        await oprot.WriteFieldBeginAsync(field, cancellationToken);
        {
          ...
          foreach (ThrottleType _iter37 in ThrottleLimit.Keys)
          {
            await oprot.WriteI32Async((int)_iter37, cancellationToken);
            await ThrottleLimit[_iter37].WriteAsync(oprot, cancellationToken);
          }
  ...
  {
    var other = that as TThrottleQuota;
