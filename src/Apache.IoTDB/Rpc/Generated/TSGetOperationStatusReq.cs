...
public partial class TSGetOperationStatusReq : TBase
{
  ...
  {
    var tmp105 = new StringBuilder("TSGetOperationStatusReq(");
    tmp105.Append(", SessionId: ");
    SessionId.ToString(tmp105);
    tmp105.Append(", QueryId: ");
    QueryId.ToString(tmp105);
    tmp105.Append(')');
