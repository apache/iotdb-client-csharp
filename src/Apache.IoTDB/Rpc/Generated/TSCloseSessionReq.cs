...
public partial class TSCloseSessionReq : TBase
{
  ...
  {
    var tmp89 = new StringBuilder("TSCloseSessionReq(");
    tmp89.Append(", SessionId: ");
    SessionId.ToString(tmp89);
    tmp89.Append(')');
