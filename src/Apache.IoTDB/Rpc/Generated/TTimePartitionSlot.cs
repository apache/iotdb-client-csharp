...
public partial class TTimePartitionSlot : TBase
{
  ...
  {
    var tmp22 = new StringBuilder("TTimePartitionSlot(");
    tmp22.Append(", StartTime: ");
    StartTime.ToString(tmp22);
    tmp22.Append(')');
