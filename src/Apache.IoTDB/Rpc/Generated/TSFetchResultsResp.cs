...
public partial class TSFetchResultsResp : TBase
{
            ...
            {
              {
                ...
                QueryResult = new List<byte[]>(_list119.Count);
                for(int _i120 = 0; _i120 < _list119.Count; ++_i120)
                {
                  byte[] _elem121;
                  _elem121 = await iprot.ReadBinaryAsync(cancellationToken);
                  QueryResult.Add(_elem121);
                }
  ...
  public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
  {
    ...
    try
    {
      var tmp122 = new TStruct("TSFetchResultsResp");
      ...
      tmp123.Name = "hasResultSet";
      tmp123.Type = TType.Bool;
      tmp123.ID = 2;
      await oprot.WriteFieldBeginAsync(tmp123, cancellationToken);
      ...
      {
        tmp123.Name = "nonAlignQueryDataSet";
        tmp123.Type = TType.Struct;
        tmp123.ID = 5;
        await oprot.WriteFieldBeginAsync(tmp123, cancellationToken);
  ...
  {
    var tmp125 = new StringBuilder("TSFetchResultsResp(");
    if((Status != null))
    {
      tmp125.Append(", Status: ");
      Status.ToString(tmp125);
    }
    tmp125.Append(", HasResultSet: ");
    HasResultSet.ToString(tmp125);
    tmp125.Append(", IsAlign: ");
    IsAlign.ToString(tmp125);
    if((QueryDataSet != null) && __isset.queryDataSet)
    {
      tmp125.Append(", QueryDataSet: ");
      QueryDataSet.ToString(tmp125);
    }
    if((NonAlignQueryDataSet != null) && __isset.nonAlignQueryDataSet)
    {
      tmp125.Append(", NonAlignQueryDataSet: ");
      NonAlignQueryDataSet.ToString(tmp125);
    }
    if((QueryResult != null) && __isset.queryResult)
    {
      tmp125.Append(", QueryResult: ");
      QueryResult.ToString(tmp125);
    }
    if(__isset.moreData)
    {
      tmp125.Append(", MoreData: ");
      MoreData.ToString(tmp125);
    }
    tmp125.Append(')');
